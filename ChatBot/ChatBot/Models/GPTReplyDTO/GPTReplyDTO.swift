...
extension Model {
    struct GPTReplyDTO: Decodable, Identifiable {
        let id: String
        ...
        init(from decoder: Decoder) throws {
            ...
            self.usage = try container.decode(GPTReplyDTO.Usage.self, forKey: .usage)
        }
    }
}

extension Model.GPTReplyDTO {
